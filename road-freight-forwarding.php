<?php require_once("inc/header.php");?>
   <title> Road freight forwarding services - Global Et Incolumem </title>
   <!-- Document Wrapper-->
            ...
            <div class="col-12 col-lg-10 offset-lg-1">
              <div class="title text-center">
                <div class="title-heading">
                  <h1>Road freight forwarding services </h1>
                </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-4 order-2 order-lg-0">
              <div class="sidebar sidebar-case-study">
                ...
                <div class="widget widget-reservation"><img src="asset/images/blog/sidebar/reservation.jpg" alt="Background Image"/>
                  <div class="widget-content">
                    <h5>Transportation of Road freight forwarding services</h5>
                    <p>Multitrack Cargo Express offers rapid land-based door-to-door freight deliveries – including groupage, part-load, full-load and express services. You'll get the benefit of our extensive experience in managing freight services through an established network of selected road, rail and intermodal partners</p><a class="btn btn--transparent btn--inverse btn--block" href="contact-us">Schedule An Appointment</a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="col-sm-12 col-md-12 col-lg-8">
        <div class="case-study-entry">
          <div class="entry-content">
            <div class="entry-bio">
             <h5>Transportation of Road freight forwarding services</h5>
                    <p>Multitrack Cargo Express offers rapid land-based door-to-door freight deliveries – including groupage, part-load, full-load and express services. You'll get the benefit of our extensive experience in managing freight services through an established network of selected road, rail and intermodal partners</p>

           
			  <p>We provide transport to all destinations, whether personal effects, Bulk / Project cargo, containerized or loose cargo, Multitrack Cargo Express Limited to get your goods there. We have a wide expertise in road freight services in USA and beyond.</p>
			  <p>We have state of the art fleet, maintained in top notch condition, guaranteeing excellence in our Road Freight services. All our drivers are qualified and have many years of experience in driving trucks across several countries, this helps to add on to the safety of your cargo while on the road.</p>
            

    
    <h5 class="text-secondary"><i>10+ Years Of Excellent Services</i></h5>
              <h5>The overland solution</h5>
                  <p>We offer a broad spectrum of overland services to several countries in Africa. Our team of road freight experts are dedicated to finding the most suitable solution for your transportation needs, whether you are looking to ship full truck loads or less than truck loads.</p>
                  <p>We act as an extension of your business operations, creating freight movement solutions which match your needs and goals.</p>

    
          
             <p>Our road Cargo services comprised of:</p>
             <ul>
				<li>Full Truck Load (door step delivery)</li>
				<li> Partial truck load (door step delivery)</li>
				<li> Tailored solutions</li>
				<li> Multimodal transportation</li>
				
			 </ul>
			 <p>Thanks to our strategic alliances around the globe, you have the flexibility to choose from a range of air freight service options tailored to your precise needs, complete with end-to-end visibility.</p>
            </div>
          </div>
        </div>
