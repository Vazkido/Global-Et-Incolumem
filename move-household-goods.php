<?php require_once("inc/header.php");?>
   <title> Household Goods - Global Et Incolumem </title>
   <!-- Document Wrapper-->
            ...
            <div class="col-sm-12 col-md-12 col-lg-4 order-2 order-lg-0">
              <div class="sidebar sidebar-case-study">
                ...
                <div class="widget widget-reservation"><img src="asset/images/blog/sidebar/reservation.jpg" alt="Background Image"/>
                  <div class="widget-content">
                    <h5>Transportation of Household Goods:</h5>
                    <p>We also transport customer's household goods via roads. We try maximum to deliver the goods within the stipulated time frame and safety.</p><a class="btn btn--transparent btn--inverse btn--block" href="contact-us">Schedule An Appointment</a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="col-sm-12 col-md-12 col-lg-8">
        <div class="case-study-entry">
          <div class="entry-content">
            <div class="entry-bio">
             <h5>Transportation of Household Goods:</h5>
              <p>We also transport customer's household goods via roads. We try maximum to deliver the goods within the stipulated time frame and safety.</p>

              <h5>Moving and Relocating</h5>
			  <p>Understanding all the details pertaining to the packing of the household goods, we offer safe and prompt relocating services. Once the task is handled to us, we relieve customers from all worries, by providing on time delivery at customer's doorstep.</p>
            

    
              <h5>Moving and Relocating:</h5>
             <p>Understanding all the details pertaining to the packing of the household goods, we offer safe and prompt relocating services.</p>

    
              <h5>Transportation</h5>
             <p>We provide door to door transportation service to our customers. Our transporting vehicles are well maintained.</p>

    
              <h5>Loading and Unloading:</h5>
             <p>All the Loading and Unloading activities are done under experiences supervision and carried out by well trained workers.</p>
