<?php require_once("inc/header.php");?>
   <title> Freight Consultation - Global Et Incolumem </title>
   <!-- Document Wrapper-->
              ...
              <div class="case-study-entry">
                <div class="entry-content">
                  <div class="entry-bio">
                    ...
                    <p>We, as being a licensed Freight Consultation for Domestic (DOT) & International (FMC & IATA) shipping, not only act on behalf of them in arranging transportation services but also facilitate documentation & other related services required by them to complete their sales transaction.</p>
                  </div>
