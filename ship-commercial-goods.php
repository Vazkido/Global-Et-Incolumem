<?php require_once("inc/header.php");?>
   <title> Ship commercial goods - Global Et Incolumem </title>
   <!-- Document Wrapper-->
            ...
            <div class="col-sm-12 col-md-12 col-lg-4 order-2 order-lg-0">
              <div class="sidebar sidebar-case-study">
                ...
                <div class="widget widget-reservation"><img src="asset/images/blog/sidebar/reservation.jpg" alt="Background Image"/>
                  <div class="widget-content">
                    <h5>Local and Long Distance</h5>
                    <p>The commercial goods moving services of our company allows the customers to move their commercial goods from one place to another without any damage.</p><a class="btn btn--transparent btn--inverse btn--block" href="contact-us">Schedule An Appointment</a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="col-sm-12 col-md-12 col-lg-8">
        <div class="case-study-entry">
          <div class="entry-content">
            <div class="entry-bio">
             <h5>Local and Long Distance</h5>
              <p>The commercial goods moving services of our company allows the customers to move their commercial goods from one place to another without any damage.</p>

      
			  <p>
We are providing high quality commercial goods packing and moving services to our customers to ship their goods such as furniture, fixtures, cabinets, computers, hospital equipments, vehicles both two wheelers and four wheelers to their location.
</p>
            

    
              <h5>Air Freight Service</h5>
             <p>Air Freight is the fastest way to ship customer's goods to the destination. We are fully equipped and have well trained people to handle for special projects, oversized cargo and dangerous goods.</p>

    
              <h5>Ocean Freight Service</h5>
             <p>Ocean freight is the main facilitator for international shipping it allows to make shipments of large amount of cargo. Ocean freight can be done in many ways, like container, bulk cargo etc. The most common shipping in international freight is ocean freight by container.
</p>

    
              <h5>Domestic Freight Service</h5>
             <p>We offer our customers with proficient Domestic Transportation services. With the assistance of our trustworthy agents located at strategic locations, we are able to serve our customers at the remote areas as well.</p>
    
              <h5>FCL (Full Container Load)</h5>
             <p>We offer wide range of containers; every container is designed to meet different needs. These can be fully enclosed, temperature-controlled or simply a flat base for oversize goods.</p>
